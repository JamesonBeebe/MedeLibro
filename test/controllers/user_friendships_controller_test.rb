...
class UserFriendshipsControllerTest < ActionController::TestCase
	...
	context "#new" do
		...
		context "when logged in" do
			...
			should "display the friend's name" do
				get :new, friend_id: users(:arthur)
			...
			should "assign a new user friendship to the correct friend" do
				get :new, friend_id: users(:arthur)
				assert_equal users(:arthur), assigns(:user_friendship).friend
			end

			should "assign a new user friendship to the currently logged in user" do
				get :new, friend_id: users(:arthur)
				assert_equal users(:jameson), assigns(:user_friendship).user
			end
			...
			should "ask if you really want to friend the user" do
				get :new, friend_id: users(:arthur)
				assert_match /Do you really want to friend #{users(:arthur).full_name}?/, response.body
			end
		end
	end
	...
	context "#create" do
		context "when not logged in" do
			should "redirect to the lgin page" do
				get :new
				assert_response :redirect
